...
\left\{
% https://q.uiver.app/?q=
\begin{tikzcd}[row sep={15mm,between origins},column sep={13mm,between origins},labl/.style={rotate=90,pos=0.5}]
	{X\!\!:} &[-6mm] {X_x} & {X_y} & {X_z} & {X_w} \\
	{X_3\!:} & {X_{3x}} & {X_{3y}} & {X_{3z}} & {X_{3w}} \\
	{X_2\!:} & {X_{2x}} & {X_{2y}} & {X_{2z}} & {X_{2w}} \\
	{X_1\!:} & {X_{1x}} & {X_{1y}} & {X_{1z}} & {X_{1w}}
	\arrow[from=2-2, to=2-3]
...
\end{tikzcd}
\middle|
\,x.X_{i+1} \subseteq X_i
\right\}
\xleftrightarrow{\hspace{1.4cm}}\left\{
% https://q.uiver.app/?q=
\begin{tikzcd}[row sep={12mm,between origins},column sep={14mm,between origins},labl/.style={rotate=90,pos=0.5}]
	&[-5mm] {X_x} & {X_y} & {X_z} & {X_w} \\
	{\Phi(X)\!:} & {X_x} & {X_y} & {X_z} & {X_w} \\
	& {X_x} & {X_y} & {X_z} & {X_w} \\
...
We still follow \cite[2.3]{maksimau2019flag} in this subsection with a few variations. All the representation in this paper is supposed to be of \textbf{finite dimension}.
...
Fix a quiver representation $X \in \Rep(Q)$, a \textbf{strict partial flag} of $X$ is defined as an increasing sequence of subrepresentation $(M_i)_i$ of $X$ such that for any arrow $x \in v(Q)$ and any $i$, we have $x.M_{i+1} \subseteq M_{i}$. For an integer $d \geqslant 2$, we denote
$$\Flagdstr(X):=\left\{ 0 \subseteq M_1 \subseteq \cdots M_d \subseteq X\mid x.M_{i+1} \subseteq M_i \right\}$$
...
\end{proof}
We can abbreviate the Proposition \ref{prop:flag=gr} as 
...
\end{defn}
Now we can write (strict) partial flag and Grassmannian as disjoint union of several pieces. Take the nonstrict case as an example. Fix a dimension vector $\dimvec{f}$ of $R_d$, it can be viewed as $d$ dimension vectors $(\dimvec{f_1},\ldots,\dimvec{f_d})$. Define
\begin{equation*}
\begin{aligned}
...
Finally, we need to define the ``Euler form" of two dimension vectors.
