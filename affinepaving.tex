...
\end{proof}
\begin{lemma}[follows {\cite[Lemma 31(1)(2)]{irelli2019cell}}, and the proof is same]\hspace{1mm}\\
Let $f:X \longrightarrow \tau S$ be a non-zero morphism, then $X_S=\ker (f)$;\\
