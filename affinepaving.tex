...
In this section, $Q$ denotes a Dynkin quiver.
...
Now we've nearly prepared every step of the proof of Theorem \ref{thm:Dynkincase}. By following the process in Figure \ref{fig:flowchart}, we now prove Theorem \ref{thm:Dynkincase} assuming Theorem \ref{thm:bigorder}. We will prove Theorem \ref{thm:bigorder} in Appendix \ref{appendix:proofcomplement}.
...
\section{Proof of Theorem \ref{thm:bigorder}}\label{appendix:proofcomplement}

The task of this appendix is to prove Theorem \ref{thm:bigorder}. When the quiver $Q$ is of type $A$ or $D$, Theorem \ref{thm:bigorder} is trivially true since no indecomposable representation can have order bigger than two. So we only concentrate on type $E$.
