...
We still follow \cite[2.3]{maksimau2019flag} in this subsection with a few variations. %The functor $\Phi$ realizes a partial flag as a quiver subrepresentation. Maybe it's wrong.
\begin{defn}[partial flag]
...
\end{defn}
\begin{defn}[strict partial flag]
