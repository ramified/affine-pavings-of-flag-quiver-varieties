...
The general case follows by induction on the dimension vector. Let $M \cong M_1 \oplus M_2$, then by applying Theorem \ref{thm:main1} to the short exact sequence 
